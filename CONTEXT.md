...
- Give the three coordinate axes modestly stronger screen-space strokes, with arrowheads scaled to match. Keep the image-plane outer frame slightly heavier than its centre guides; the internal guides should remain about two-thirds of the frame weight.
