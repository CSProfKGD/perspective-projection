...
- Set the main coordinate equations and variables in neutral white or graphite, optionally using the marker yellow only for their live numeric tuples. Connect each coordinate label to its corresponding point with a thin, low-opacity neutral leader.
